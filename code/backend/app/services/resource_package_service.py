        ...
        *,
        ...
        try:
            ...
            for artifact in response.artifacts:
                ...
                resource = Resource(
                    ...
                    subject=resolve_resource_subject(
                        response.subject, request.topic, request.node_label, artifact.title
                    ),
                    ...
                    content={"preview": artifact.preview, "artifact_kind": artifact.kind},
                    url=artifact.download_url,
                    knowledge_point=request.node_label or request.topic,
            ...
            enriched_artifacts = [
                ...
                for artifact, resource in zip(response.artifacts, resources)
            ]
