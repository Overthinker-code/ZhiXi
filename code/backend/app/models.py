...
class ResourceBase(SQLModel):
    ...
    file_path: str = Field(default="", max_length=255)
    ...
    knowledge_point: Optional[str] = Field(default=None, max_length=160, index=True)
    difficulty: Optional[str] = Field(default=None, max_length=32, index=True)
    source: Optional[str] = Field(default=None, max_length=80, index=True)
