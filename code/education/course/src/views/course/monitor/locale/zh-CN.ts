export default {
  ...
  'monitor.liveMethod.normal': '普通课堂',
  'monitor.liveMethod.flowControl': '控流课堂',
  'monitor.liveMethod.video': '视频课堂',
  'monitor.liveMethod.web': '网页开播',
  'monitor.editCarousel': '编辑轮播',
  'monitor.startCarousel': '开始轮播',
  'monitor.quickOperation.changeClarity': '切换清晰度',
  'monitor.quickOperation.switchStream': '开启课堂行为检测',
  'monitor.quickOperation.removeClarity': '开启聊天窗口',
  'monitor.quickOperation.pushFlowGasket': '录制课堂',
  'monitor.studioInfo.label.studioTitle': '课堂标题',
  'monitor.studioInfo.label.onlineNotification': '上线通知',
  'monitor.studioInfo.label.studioCategory': '课堂类目',
  'monitor.studioInfo.placeholder.studioTitle': '的课堂',
  'monitor.studioInfo.btn.fresh': '更新',
  'monitor.studioStatus.title.studioStatus': '课堂状态',
