export default {
  'menu.form.step': '课堂分析',
  'stepForm.step.title': '课堂行为分析',
  'stepForm.step.title.baseInfo': '选择课堂',
  'stepForm.step.subTitle.baseInfo': '课堂基本信息',
  ...
  'stepForm.form.error.activityName.pattern':
    '输入汉字、字母或数字，最多20字符',
  'stepForm.form.label.channelType': '选择课堂',
  'stepForm.placeholder.channelType': '请选择录制课堂',
