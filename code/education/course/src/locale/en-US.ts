...
import localeCourseMonitor from '@/views/course/monitor/locale/en-US';
...
export default {
  ...
  'menu.profile.userInfo': 'User Info',
  'menu.profile.learningData': 'Learning Data',
  'menu.profile.chat': 'AI Assistant',
  ...
  'menu.digitalHuman.textToVideo': 'Text to Video',
  'menu.digitalHuman.clone': 'Digital Human Clone',
  'menu.digitalHuman.my': 'My Digital Humans',
